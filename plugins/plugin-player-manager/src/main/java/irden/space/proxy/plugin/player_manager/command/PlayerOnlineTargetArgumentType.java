...
public final class PlayerOnlineTargetArgumentType implements ArgumentType<PlayerTarget> {

    private final Supplier<PlayerManagerApi> playerManagerApiSupplier;

    private PlayerOnlineTargetArgumentType(Supplier<PlayerManagerApi> playerManagerApiSupplier) {
        this.playerManagerApiSupplier = Objects.requireNonNull(playerManagerApiSupplier, "playerManagerApiSupplier");
    }

    public static PlayerOnlineTargetArgumentType playerTarget(PlayerManagerApi playerManagerApi) {
        Objects.requireNonNull(playerManagerApi, "playerManagerApi");
        return new PlayerOnlineTargetArgumentType(() -> playerManagerApi);
    }

    public static PlayerOnlineTargetArgumentType playerTarget(Supplier<PlayerManagerApi> playerManagerApiSupplier) {
        return new PlayerOnlineTargetArgumentType(playerManagerApiSupplier);
    }
