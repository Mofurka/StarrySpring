...
public class PacketParserRegistry {
    ...
    public PacketParserRegistry() {
        ...
        register(PacketType.PAUSE, null);
        register(PacketType.SERVER_INFO, null);
        register(PacketType.CLIENT_CONNECT, null);
        ...
        register(PacketType.ENTITY_MESSAGE, null);
        register(PacketType.ENTITY_MESSAGE_RESPONSE, null);
