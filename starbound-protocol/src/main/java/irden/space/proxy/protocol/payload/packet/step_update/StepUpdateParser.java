...
public class StepUpdateParser implements PacketParser<StepUpdate> {
    @Override
    public StepUpdate parse(BinaryReader reader, int openProtocolVersion) {
         if (openProtocolVersion == -1) {
    ...
    @Override
    public byte[] write(StepUpdate payload, int openProtocolVersion) {
